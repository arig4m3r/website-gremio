        ...
        <div className="lg:max-w-lg">
          ...
          <div className="mt-8 space-y-5">
            <p className="flex items-center -mx-2 text-gray-700">
              ...
              <span className="mx-2">Mude o futuro com suas idéias</span>
            </p>
            ...
            <p className="flex items-center -mx-2 text-gray-700">
              ...
              <span className="mx-2">Fique por dentro das novidades</span>
            </p>
            ...
            <p className="flex items-center -mx-2 text-gray-700">
              ...
              <span className="mx-2">Facil de usar</span>
            </p>
          </div>
        </div>
