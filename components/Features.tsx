        ...
        <div className="flex flex-wrap -mx-4">
          <div className="w-full md:w-1/2 lg:w-1/3 px-4">
            ...
            >
              ...
              <h4 className="font-semibold text-xl text-dark mb-3">Função 1</h4>
              <p className="text-body-color">
                Descrição da função 1 aqui! Lorem ipsum dolor sit amet
          ...
          <div className="w-full md:w-1/2 lg:w-1/3 px-4">
            ...
            >
              ...
              <h4 className="font-semibold text-xl text-dark mb-3">Função 4</h4>
              <p className="text-body-color">
                Descrição da função 4 aqui! Lorem ipsum dolor sit amet
                consectetur adipisicing elit. Explicabo eligendi, ut numquam
                dolores exercitationem unde alias! Rerum nobis aperiam, dolores,
                nam enim provident a modi ut laudantium ad ab praesentium.
              </p>
          ...
          <div className="w-full md:w-1/2 lg:w-1/3 px-4">
            ...
            >
              ...
              <h4 className="font-semibold text-xl text-dark mb-3">Função 5</h4>
              <p className="text-body-color">
                Descrição da função 5 aqui! Lorem ipsum dolor sit amet
                consectetur adipisicing elit. Explicabo eligendi, ut numquam
                dolores exercitationem unde alias! Rerum nobis aperiam, dolores,
                nam enim provident a modi ut laudantium ad ab praesentium.
              </p>
          ...
          <div className="w-full md:w-1/2 lg:w-1/3 px-4">
            ...
            >
              ...
              <h4 className="font-semibold text-xl text-dark mb-3">Função 6</h4>
              <p className="text-body-color">
                Descrição da função 6 aqui! Lorem ipsum dolor sit amet
                consectetur adipisicing elit. Explicabo eligendi, ut numquam
                dolores exercitationem unde alias! Rerum nobis aperiam, dolores,
                nam enim provident a modi ut laudantium ad ab praesentium.
              </p>
